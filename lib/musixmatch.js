...
const getLyrics = url => {
    return new Promise((resolve, reject) => {
        ...
        .then(body => {
            ...
            let lyrics = $('div[class="mxm-track-lyrics-container"] div[class="mxm-lyrics"] span').first().text();
            if(lyrics === 'Edit lyrics') {
                $('div[class="mxm-track-lyrics-container"] div[class="mxm-lyrics"] span').first().remove();
                lyrics = $('div[class="mxm-track-lyrics-container"] div[class="mxm-lyrics"] span').first().text();
            }
